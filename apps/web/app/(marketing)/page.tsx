        ...
        >
          ...
          <div className="flex flex-nowrap items-center justify-between gap-2 w-full overflow-x-auto pb-2 sm:pb-0 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:'none'] [scrollbar-width:'none']">
            {[
              ...
              { name: "Luxury Bus", src: "/vehicle-img/bus.jpeg" },
              { name: "Train", src: "/vehicle-img/train.png" },
              { name: "Ship/Ferry", src: "/vehicle-img/ship.png" },
            ].map((item) => (
...
export default function Home() {
  ...
  return (
    <>
      ...
      {/* Need Charter Button */}
      <div className="fixed bottom-2 right-2 sm:right-4 sm:bottom-3 z-50 flex">
        <button 
          onClick={() => setIsCharterModalOpen(true)}
          className="bg-emerald-600 hover:bg-emerald-700 text-white shadow-[0_8px_30px_rgb(0,0,0,0.12)] hover:shadow-[0_8px_30px_rgba(16,185,129,0.3)] flex items-center justify-center font-semibold text-sm transition-all hover:-translate-y-1 active:scale-95 px-4 py-1.5 sm:px-5 sm:py-2 rounded-full"
        >
